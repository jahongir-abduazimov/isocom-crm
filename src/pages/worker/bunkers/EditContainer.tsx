...
const EditContainer: React.FC = () => {
    const { bunkerId, containerId } = useParams<{ bunkerId: string; containerId: string }>();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!validateForm() || !containerId) return;
    ...
    if (isLoading) {
        return (
            <div className="flex justify-center items-center py-12">
                ...
                <span className="ml-2 text-gray-600">Container ma'lumotlari yuklanmoqda...</span>
            </div>
        );
    }
    ...
    if (!currentContainer) {
        return (
            <div className="text-center py-12">
                ...
                <Button onClick={() => navigate(`/worker/bunkers/${bunkerId}/containers`)}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            >
                                ...
                                {isSubmitting || containersLoading ? "Yangilanmoqda..." : "Yangilash"}
                            </Button>
