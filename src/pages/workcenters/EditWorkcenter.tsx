...
export default function EditWorkcenterPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        notifyError("Stanok ma'lumotlarini yuklashda xatolik");
        navigate("/workcenters");
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        notifySuccess("Stanok muvaffaqiyatli yangilandi!");
        navigate("/workcenters");
      } else {
        notifyError("Stanok yangilanmadi yoki xatolik yuz berdi");
      }
    } catch (e) {
    ...
    return (
      <div className="flex justify-center items-center py-12">
        ...
        <span className="ml-2 text-gray-600">
          Stanok ma'lumotlari yuklanmoqda...
        </span>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1 text-sm lg:text-base">
            Stanok ma'lumotlarini yangilash
          </p>
        </div>
      </div>
