    ...
    <div className="">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            Stanoklar (Workcenters)
          </h1>
          <p className="text-gray-600 mt-1">
            Ishlab chiqarish stanoklarini boshqarish va kuzatish
          </p>
        </div>
        <Button
          ...
          <div className="flex gap-4 items-center">
            <div className="flex-1">
              <div className="relative">
                ...
                />
                <Input
                  placeholder="Stanoklarni qidirish..."
                  value={searchTerm}
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={locationFilter} onValueChange={setLocationFilter}>
                <SelectTrigger className="w-[180px]">
                  <SelectValue placeholder="Joylashuv tanlang" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">Barcha joylashuvlar</SelectItem>
                  <SelectItem value="no-location">Joylashuv yo'q</SelectItem>
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={typeFilter} onValueChange={setTypeFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="no-type">Tur yo'q</SelectItem>
      ...
      {loading && (
        <div className="flex justify-center items-center py-12">
          ...
          <span className="ml-2 text-gray-600">Stanoklar yuklanmoqda...</span>
        </div>
      )}
      ...
      <ConfirmModal
        open={modalOpen}
        title="Stanokni o'chirish"
        description="Ushbu stanokni o'chirishni tasdiqlaysizmi?"
                ...
                {filteredWorkcenters.map((workcenter) => (
                  <tr key={workcenter.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 lg:px-6 py-4 whitespace-nowrap">
                      ...
                      >
                        {workcenter.is_active ? "Faol" : "Nofaol"}
                      </span>
                    </td>
      ...
      {!loading && !error && filteredWorkcenters.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-lg">
            Qidiruv mezonlaringizga mos stanoklar topilmadi.
          </p>
        </div>
      )}
    </div>
