                ...
                <div className="px-6 py-2">
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Select onValueChange={(val) => setValue("finished_product", val)}>
                                <SelectTrigger>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Select onValueChange={(val) => setValue("semi_finished_product", val)}>
                                <SelectTrigger>
                                    <SelectValue placeholder="Yarim tayyor maxsulot tanlang" />
                                </SelectTrigger>
                                <SelectContent>
                                    {products
                                        .filter((product) => product.type === "SEMI_FINISHED_PRODUCT")
                                        .map((product) => (
                                            <SelectItem key={product.id} value={product.id!}>
                                                {product.name}
                                            </SelectItem>
